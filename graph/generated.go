...
type MutationResolver interface {
	...
	Signin(ctx context.Context, input model.SignIn) (string, error)
}
...
func (ec *executionContext) field_Mutation_signin_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 model.SignIn
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNSignIn2githubᚗcomᚋtonrock01ᚋgo_fiber_gqlᚋgraphᚋmodelᚐSignIn(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_signup_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNSignUp2githubᚗcomᚋtonrock01ᚋgo_fiber_gqlᚋgraphᚋmodelᚐSignUp(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_signin(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Signin(rctx, fc.Args["input"].(model.SignIn))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputSignIn(ctx context.Context, obj interface{}) (model.SignIn, error) {
	var it model.SignIn
...
func (ec *executionContext) unmarshalNSignIn2githubᚗcomᚋtonrock01ᚋgo_fiber_gqlᚋgraphᚋmodelᚐSignIn(ctx context.Context, v interface{}) (model.SignIn, error) {
	res, err := ec.unmarshalInputSignIn(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) unmarshalNSignUp2githubᚗcomᚋtonrock01ᚋgo_fiber_gqlᚋgraphᚋmodelᚐSignUp(ctx context.Context, v interface{}) (model.SignUp, error) {
